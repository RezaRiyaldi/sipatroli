...
<html lang="en">
  ...
  <link href="home/img/apple-touch-icon.png" rel="apple-touch-icon">
        ...
        <script src="<?=base_url('home/components/jquery/jquery.min.js'); ?>" type='text/javascript'></script>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('form/dataperusahaan');?>">
                        <i class="fas fa-fw fa-table"></i>
                        <span>Data Perusahaan</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('form/createperusahaan');?>">
                        <i class="fas fa-fw fa-table"></i>
                        <span>Input Perusahaan</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('form/createshp');?>">
                        <i class="fas fa-fw fa-table"></i>
                        <span>Input SHP File</span></a>
                </li>
                    ...
                    <footer class="sticky-footer bg-white">
                        <div class="container my-auto">
                            <div class="copyright text-center my-auto">
                                ...
                                Made with <span style="color: #e25555;">&hearts;</span>  in Kabupaten Tangerang
                            </div>
                        </div>
                    </footer>
                    <!-- End of Footer -->
